...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?OnPlaceholderProxyConnected@BufferingMessageCallHost@BamoImpl@Microsoft@@QEAAXII@Z
    void OnPlaceholderProxyConnected(unsigned int, unsigned int);
    // Category: Refcount | Source: PDB Internal
...
private:
    // Category: Method | Source: PDB Internal
    // Symbol: ?AddNewBufferStream@BufferingMessageCallHost@BamoImpl@Microsoft@@AEAAPEAUBufferStream@23@_K@Z
    ::Microsoft::BamoImpl::BufferStream * AddNewBufferStream(uint64_t);
    // Category: Method | Source: PDB Internal
