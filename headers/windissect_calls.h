...
static constexpr wchar_t module_name[23] = {0x0054, 0x0065, 0x0078, 0x0074, 0x0049, 0x006E, 0x0070, 0x0075, 0x0074, 0x0046, 0x0072, 0x0061, 0x006D, 0x0065, 0x0077, 0x006F, 0x0072, 0x006B, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 360785011U || rva >= image_size) return nullptr;
return base + rva;
}
