//! Windissect-generated Rust FFI bindings for TextInputFramework.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "34A2C0A7DA23212E70024181ADFB5B3C";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 360785011;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 23] = [84, 101, 120, 116, 73, 110, 112, 117, 116, 70, 114, 97, 109, 101, 119, 111, 114, 107, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 360785011 { return 0; }
